...
<header class="mui-bar mui-bar-nav">
		...
		<div class="mui-content">
			...
			<div class="order" style="padding-bottom:50px">
				<div class="order-info" v-if="json[0].ORDER_ID" v-for="(detail,index) in json" :key="index">
            ...
            <p style="text-align:left">用户评分: <span ><Rate style="vertical-align: top;margin-top: -6px;" disabled allow-half v-model="detail.STAR"></Rate></span></p>
